    ...
    <div>
      <div className="top-picks-container">
        <ul className="top-picks">
          {/* I added this anchor tag to allow the user to stream the tracks in one place*/}
          <a
            href="https://soundcloud.com/matthew-young-493848941/sets/die-elated-top-picks"
            target="_blank"
